...
class TestSmithWilson(unittest.TestCase):
    ...
    def test_big_g_1(self):
        ...
        #Actual output
        actual = sw.big_g(alfa, q, nrofcoup, t2, tau)[0]
    ...
    def test_big_g_2(self):
        ...
        #Actual output
        actual = sw.big_g(alfa, q, nrofcoup, t2, tau)[1]
    ...
    def test_smith_wilson_bruto_force(self):
        ...
        #Actual output
        actual = sw.smith_wilson_brute_force(instrument, liqmat, rates, nrofcoup, cra, ufr, alfamin, tau, t2)[1]
